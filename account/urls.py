...
urlpatterns = patterns('',
    ...
    (r'^password/change/$', change_password_authenticated, { 'section': 'password', 'template': 'account/password_change.html'}),
    (r'^password/change/done/$', direct_to_template, { 'extra_context': {'section': 'password'}, 'template': 'account/password_change_done.html'}),
    (r'^email/change/$', email_change, { 'section': 'email', 'template': 'account/email_change.html'}),
    (r'^email/change/processed/$', direct_to_template, { 'extra_context': {'section': 'email'}, 'template': 'account/email_change_processed.html'}),
    (r'^email/change/(?P<key>.{70})/$', change_email_with_key, { 'section': 'email', 'template': 'account/email_change_done.html'}),
