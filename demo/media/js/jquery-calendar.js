...
$.extend(PopUpCal.prototype, {
	...
	_inlineCalendar: function(target, inst) {
		...
		// dave
		if ($("form #id_birthdate").length > 0) {
			var arr =  $("#id_birthdate").val().split("-"); 
			inst._selectedDay = parseInt(arr[2], 10);
			inst._selectedMonth = parseInt(arr[1], 10) - 1;
			inst._selectedYear = parseInt(arr[0], 10);
		}
		// dave
